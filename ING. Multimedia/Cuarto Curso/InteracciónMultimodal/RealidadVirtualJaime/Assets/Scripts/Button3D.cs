...
public class Button3D : MonoBehaviour
{
    ...
    public TipoBoton triggerType = TipoBoton.BOTON_CAMBIAR_MUNDO;
    ...
    void Update () 
    {
        ...
        // Si es un botón para cambiar de tipo de mundo (AR -> VR)
        if (triggerType == TipoBoton.BOTON_CAMBIAR_MUNDO) { 
